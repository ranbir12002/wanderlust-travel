...
export default async function DynamicDomesticDestinationPage(props: {
  ...
  if (!destination || destination.category !== "domestic") {
    notFound();
  }
  ...
  return (
    <TripsPageContent
      ...
      heroImage={destination.heroImage || "/hero banner/1.jpg"}
